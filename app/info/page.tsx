        ...
        <Card>
            ...
            <CardContent className="space-y-3 md:space-y-5">
                ...
                <p>
                    ...
                    purpose. But, if those songs didn't necessarily match my
                    everyday taste in music, Spotify's recommendation engine
...
function Project() {
    return (
        <Card>
            ...
            <CardContent className="space-y-3 md:space-y-5">
                <p>
                    Across my recent personal projects, I've been searching for
                    a set of technologies that I felt excited to use every time.
                    For Playlist.me, I hoped to settle into a tech stack that
                    I'd feel comfortable continuing to use for my next several
                    projects.
                </p>
                <p>
                    React has been my preference for some time, but before this,
                    hadn't yet dived into Next.js, and saw this as an excellent
                    opportunity. Adapting to the tight coupling of server and
                    client while still working in a paradigm I mesh with was the
                    right blend of comfort and challenge.
                </p>
                <p>
                    In the past I've worked with a variety of CSS solutions and
                    component libraries. The utility-first approach of Tailwind
                    is something I love, but I also enjoy libraries like Chakra
                    UI for well-designed components. When i discovered
                    shadcn/ui, built on top of Radix and Tailwind, I was
                    immediately sold.
                </p>
                <p></p>
            </CardContent>
    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-3 md:space-y-5">
                ...
                <p>
                    I couldn't say that I was truly happy with what I had put
                    together, but at the same time I was proud of what was my
                    first ever functional web application. I moved on to other
                    projects, but could never shake a nagging feeling that
